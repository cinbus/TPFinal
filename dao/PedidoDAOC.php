...
class PedidoDAOC {
    ...
    public function getPedidoXID($id) {
        ...
        while ($pedido = $result->fetch_assoc()) {
            ...
            $pedObj = new Pedido($pedido["idpedido"],$pedido["nombre"],$pedido["apellido"],$pedido["usuario"],$pedido["mail"],$pedido["lugarentrega"], $localidad["localidad"] ,$pedido["codpostal"], $pedido["formadepago"],$pedido["tarjtitular"],$pedido["tarjnumero"],$pedido["tarjvto"],$pedido["tarjclave"]);
        }
